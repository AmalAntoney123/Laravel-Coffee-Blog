            ...
            <div class="row">
                ...
                <div class="col-md-5 " style="margin-top:150px;">
                    <div class="h-100">
                        ...
                        <p>Try one of our signature selections and see what everyone's talking about. Scroll down the
                            page to view
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6  d-flex justify-content-center align-items-center">
                    <img src="images/coffee1.png" class="img-fluid align-self-center" alt="Coffee bags"
                        style="height:400px;">
                </div>
            </div>
        </div>
