...
<body>
    ...
    navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid"> <a class="navbar-brand" href="/">Quierro
                Cafe</a> <button class="navbar-toggler" type="button" data-bs-toggle="collapse"
    ...
    <style>
        ...
        .lead {
            color: #155724;
            /* Dark green color for the text */
            font-size: 1.5em;
            margin-top: 20px;
        }
    </style>
    <section id="success" class="text-center mt-5" style="height:350px">
        <div class="container">
            <section id="success" class="text-center mt-5" style="height:350px">
                <h1 class="display-1">Success!</h1>
                <p class="lead">Payment successful. Your product will be shipped soon.</p>
